...
const QUICK_GUIDES = [
  { icon: "🌾", label: "Best Starter Farms",    href: "/articles/best-early-game-farms"          },
  { icon: "🏡", label: "Cozy Survival Bases",   href: "/articles/best-starter-house-survival"    },
  { icon: "⚡", label: "XP Farm Guide",          href: "/articles/mob-farming-101"                },
  { icon: "🗺️", label: "Early Game Tips",        href: "/articles/how-to-survive-first-night"     },
  { icon: "💎", label: "How to Find Diamonds",   href: "/articles/how-to-find-diamonds"           },
];
